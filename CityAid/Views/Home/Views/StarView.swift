...
struct StarView: View {
    ...
    var body: some View {
        TimelineView(.animation) { timeline in
            ...
            ZStack {
                RadialGradient(
                    gradient: Gradient(colors: [star.color.opacity(isTapped ? 0.35 : 0.2), .black.opacity(0)]),
                    center: .center,
                    startRadius: 0,
            ...
            .onTapGesture {
                print("Star tapped at position: (x: \(star.basePosition.x), y: \(star.basePosition.y))")
