    ...
    var body: some View {
        List {
            Section(
                ...
                footer: Text("Select which contribution types you would like to include for possible types in challenges. This ensures challenges are more relevant to you, but always try to push yourself to do more!\n\nChallenges will update at the next reset.")
            ) {
